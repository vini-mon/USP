...
// Programa adaptado por Sarita M. Bruschi para o código de soma de um escalar a um vetor utilizando instruções intrínsecas SSE
...
void addindex_vec1(float *x, int n) 
{
    __m128 index, x_vec;
...
void addindex_vec2(float *x, int n) 
{
